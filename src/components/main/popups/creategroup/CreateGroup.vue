    ...
    <div class="modal-card">
      <header class="modal-card-head">
        ...
        <button 
          class="delete" 
          aria-label="close"
          v-on:click="$store.commit('showCreateGroup', false)"></button>
      </header>
      <section class="modal-card-body">
        <p>Creating a group allows you to chat with many friends at once. <br>
        ...
        <input type="text" class="input" placeholder="Search Friends..." v-model="filter">
        <div v-for="friend in getFilteredFriends(filter)" :key="friend.address" class="friend">
          <GroupAddFriend 
            :friend="friend" 
