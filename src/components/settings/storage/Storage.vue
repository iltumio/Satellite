  ...
  <div>
    ...
    <article class="message is-dark">
      <div class="message-body">
        ...
        <div class="bordered margin-2">
          <div class="columns">
            <div class="column" style="max-width: 200px;">
              <img
                src="static/img/icons/textile-logo.png"
                class="margin"
                alt=""
              />
            </div>
            <div class="column padded">
              <p class="padded">
                ...
                <br />
                {{ $t('settings.storage.threadDB_learn_more') }}
                <a href="https://textile.io/">https://textile.io/</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <span class="yellow"
          >Disabling database not available during Alpha.</span
        >
        <!--
        <hr class="spacer">
    ...
    <article class="message is-dark">
      <div class="message-body">
        ...
        <button
          ...
          v-on:click="requestUnlimitedStorage"
        >
        ...
        <p>
          {{ $t('settings.storage.data_subtext') }}<br />
          <br />
          {{ $t('settings.storage.data_subtext_two') }}
        </p>
        <br />
        <button class="button is-danger is-small" v-on:click="clearData">
          <i class="fas fa-skull-crossbones"></i> &nbsp;
          {{ $t('settings.storage.clear_data') }}
        </button>
      </div>
    </article>
  </div>
