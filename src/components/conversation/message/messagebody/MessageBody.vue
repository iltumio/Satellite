...
<script>
  ...
  import Payment from '@/components/conversation/message/embeds/Payment';
  import Call from '@/components/conversation/message/embeds/Call';
  import ImageViewer from '@/components/conversation/message/embeds/ImageViewer';
  import File from '@/components/conversation/message/embeds/File';
  import Audio from '@/components/conversation/message/embeds/Audio';
  import Video from '@/components/conversation/message/embeds/Video';
  import Address from '@/components/conversation/message/embeds/Address';
